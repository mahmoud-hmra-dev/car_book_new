...
const strings = new LocalizedStrings({
  ...
  ar: {
    ...
    BIRTH_DATE_NOT_VALID: `يجب أن يكون عمر السائق ${env.MINIMUM_AGE} عامًا على الأقل.`,
    FORM_ERROR: 'يرجى تصحيح الأخطاء.',
    ALL: 'الكل',
    SUPPLIER: 'المورد',
    STATUS: 'الحالة',
    ...
    BIRTH_DATE_NOT_VALID_PART2: 'عامًا.',
    PAY_LATER: 'السماح بالدفع لاحقًا',
    ANY: 'أي',
    NAME: 'الاسم',
    LONGITUDE: 'خط الطول',
    LATITUDE: 'خط العرض',
    ...
    UPLOAD_DRIVER_LICENSE: 'رفع رخصة القيادة...',
    PRICE_CHANGE_RATE: 'نسبة تغيير السعر (+/- %)',
    SUPPLIER_CAR_LIMIT: 'الحد الأقصى للسيارات المسموح بها في البحث',
    NOTIFY_ADMIN_ON_NEW_CAR: 'إشعار المدير عند إضافة سيارة جديدة',
    BLACKLISTED: 'محظور',
    BLACKLISTED_TOOLTIP: 'المستخدمون المحظورون لم يعد لديهم وصول إلى المنصة.',
    FIELD_NOT_VALID: 'يرجى الالتزام بالتنسيق المطلوب',
  },
  es: {
