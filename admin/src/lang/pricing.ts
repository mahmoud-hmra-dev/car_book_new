...
const strings = new LocalizedStrings({
  ...
  ar: {
    ...
    FREE_PLAN_PRICE: 'مجانية',
    FEATURE_1: 'إنشاء عدد غير محدود من السيارات',
    FEATURE_2: 'سيارة واحدة في نتائج البحث',
    BASIC_PLAN: 'الخطة الأساسية',
    BASIC_PLAN_PRICE: '$10/شهريًا',
    FEATURE_3: '5 سيارات في نتائج البحث',
    FEATURE_4: 'دعم ذو أولوية',
    PREMIUM_PLAN: 'الخطة المميزة',
    CONTACT_US: 'تواصل معنا',
    FEATURE_5: 'عدد غير محدود من السيارات في نتائج البحث',
  },
  es: {
