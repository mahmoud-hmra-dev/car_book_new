...
By using our services, you acknowledge that you have read and understood these Terms of Service and agree to be bound by them.
  ...
  ar: {
    ...
    TOS: `
مرحبًا بك في ${env.WEBSITE_NAME}! من خلال الدخول إلى موقعنا واستخدام خدماتنا، فإنك توافق على الالتزام بشروط الاستخدام التالية. إذا لم توافق على هذه الشروط، يرجى عدم استخدام خدماتنا.

1. قبول الشروط

عند دخولك إلى خدماتنا أو استخدامها، فإنك تؤكد أنك قرأت هذه الشروط وفهمتها ووافقت عليها، وكذلك على سياسة الخصوصية الخاصة بنا.

2. استخدام خدماتنا

أنت توافق على استخدام خدماتنا فقط للأغراض القانونية وبطريقة لا تنتهك حقوق الآخرين ولا تقيّد أو تمنع استخدامهم للخدمات. ويشمل ذلك الالتزام بجميع القوانين والأنظمة المعمول بها.

3. الحجوزات والمدفوعات

عند إجراء حجز عبر ${env.WEBSITE_NAME}، فإنك توافق على تقديم معلومات دقيقة وكاملة. يجب أن تتم جميع المدفوعات عبر نظام الدفع الآمن الخاص بنا. وبعد اكتمال الدفع ستتلقى تأكيدًا لحجزك.

4. سياسة الإلغاء

قد تكون الإلغاءات التي تتم قبل 24 ساعة من تاريخ الإيجار مؤهلة لاسترداد كامل المبلغ. أما الإلغاءات التي تتم قبل أقل من 24 ساعة من تاريخ الإيجار فقد يترتب عليها رسوم إلغاء. يرجى الرجوع إلى سياسة الإلغاء للحصول على التفاصيل.

5. شروط التأجير

تخضع جميع عمليات التأجير لشروط التأجير الخاصة بنا، بما في ذلك على سبيل المثال لا الحصر قيود العمر ومتطلبات رخصة القيادة والتزامات التأمين. وتقع على عاتقك مسؤولية التأكد من استيفاء جميع المتطلبات قبل إجراء الحجز.

6. حدود المسؤولية

لن يكون ${env.WEBSITE_NAME} مسؤولًا عن أي أضرار غير مباشرة أو عرضية أو تبعية تنتج عن استخدامك لخدماتنا. وفي جميع الأحوال لن تتجاوز مسؤوليتنا الإجمالية المبلغ الذي دفعته مقابل الخدمات.

7. تعديل الشروط

نحتفظ بالحق في تعديل شروط الاستخدام هذه في أي وقت. وتصبح أي تعديلات سارية فور نشرها على موقعنا. ويُعد استمرارك في استخدام خدماتنا بعد التعديلات موافقة منك على الشروط الجديدة.

8. القانون المعمول به

تُحكم شروط الاستخدام هذه وتُفسَّر وفقًا للقوانين المعمول بها. ويتم الفصل في أي نزاعات ناشئة عنها أمام المحاكم المختصة.

9. معلومات التواصل

إذا كانت لديك أي أسئلة بخصوص شروط الاستخدام هذه، يرجى التواصل معنا عبر ${env.CONTACT_EMAIL}. نحن هنا لمساعدتك في أي استفسار يتعلق بخدماتنا.

10. الإقرار

باستخدامك لخدماتنا، فإنك تقر بأنك قرأت شروط الاستخدام هذه وفهمتها وتوافق على الالتزام بها.
    `,
  },
  es: {
