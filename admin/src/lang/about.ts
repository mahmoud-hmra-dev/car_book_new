...
const strings = new LocalizedStrings({
  ...
  ar: {
    ...
    CONTENT1: `في ${env.WEBSITE_NAME} نعلم أن كل رحلة مختلفة. لذلك نلتزم بتوفير تشكيلة متنوعة من المركبات التي تناسب جميع احتياجات السفر. سواء كنت تستكشف مدينة جديدة، أو تتنقل للعمل، أو تبحث عن مغامرة، فإن خدماتنا الموثوقة لتأجير السيارات تضمن أن تبدأ رحلتك بسهولة. مهمتنا هي تقديم خدمة عملاء استثنائية تجعل تجربتك مريحة وخالية من التوتر. مع أسعار تنافسية، ومركبات متعددة بحالة ممتازة، وفريق جاهز دائمًا للمساعدة، نسعى لنكون شريكك الموثوق على الطريق. اختر ${env.WEBSITE_NAME} لكل احتياجاتك في تأجير السيارات واستمتع بحرية الاستكشاف بالوتيرة التي تناسبك.`,
    TITLE2: `لماذا تختار ${env.WEBSITE_NAME}`,
    SUBTITLE2: 'تميّز في كل رحلة',
    CONTENT2: 'استمتع بسهولة وموثوقية وقيمة عالية مع خدمتنا المميزة لتأجير السيارات. من الحجز السلس إلى المركبات عالية الجودة، نحن شريك سفرك الذي يمكنك الاعتماد عليه.',
