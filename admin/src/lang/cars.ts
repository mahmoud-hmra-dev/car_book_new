...
const strings = new LocalizedStrings({
  ...
  ar: {
    ...
    CAR_CURRENCY: `${commonStrings.CURRENCY}/اليوم`,
    ...
    ELECTRIC_SHORT: 'K',
    HYBRID_SHORT: 'H',
    PLUG_IN_HYBRID_SHORT: 'HC',
    GEARBOX_MANUAL: 'يدوي',
    GEARBOX_AUTOMATIC: 'أوتوماتيك',
    GEARBOX_MANUAL_SHORT: 'M',
    GEARBOX_AUTOMATIC_SHORT: 'A',
    FUEL_POLICY_LIKE_FOR_LIKE: 'نفس الكمية',
    FUEL_POLICY_FREE_TANK: 'خزان مجاني',
    FUEL_POLICY_FULL_TO_FULL: 'ممتلئ إلى ممتلئ',
    FUEL_POLICY_FULL_TO_EMPTY: 'ممتلئ إلى فارغ',
    FUEL_POLICY_LIKE_FOR_LIKE_TOOLTIP: 'تُسلَّم هذه السيارة بكمية وقود محددة ويجب إعادتها بنفس الكمية.',
    FUEL_POLICY_FREE_TANK_TOOLTIP: 'السعر يشمل خزان وقود ممتلئ.',
    FUEL_POLICY_FULL_TO_FULL_TOOLTIP: 'تُسلَّم هذه السيارة بخزان وقود ممتلئ ويجب إعادتها بخزان ممتلئ.',
    FUEL_POLICY_FULL_TO_EMPTY_TOOLTIP: 'تُسلَّم هذه السيارة بخزان وقود ممتلئ ويجب إعادتها بخزان فارغ.',
    DIESEL_TOOLTIP: 'هذه السيارة تعمل بمحرك ديزل',
    GASOLINE_TOOLTIP: 'هذه السيارة تعمل بمحرك بنزين',
    ...
    GEARBOX_MANUAL_TOOLTIP: 'هذه السيارة تحتوي على ناقل حركة يدوي',
    GEARBOX_AUTOMATIC_TOOLTIP: 'هذه السيارة تحتوي على ناقل حركة أوتوماتيكي',
    SEATS_TOOLTIP_1: 'هذه السيارة تحتوي على ',
    SEATS_TOOLTIP_2: ' مقاعد',
    DOORS_TOOLTIP_1: 'هذه السيارة تحتوي على ',
    DOORS_TOOLTIP_2: ' أبواب',
    AIRCON_TOOLTIP: 'هذه السيارة مزودة بمكيف هواء',

    MILEAGE: 'عدد الكيلومترات',
    MILEAGE_UNIT: 'كم/اليوم',
    UNLIMITED: 'غير محدود',
    LIMITED: 'محدود',
    ...
    THEFT_PROTECTION_TOOLTIP: 'قد يشمل الإيجار حماية من السرقة.',
    COLLISION_DAMAGE_WAVER: 'تأمين أضرار التصادم',
    COLLISION_DAMAGE_WAVER_TOOLTIP: 'قد يشمل الإيجار تغطية أضرار التصادم.',
    FULL_INSURANCE: 'تأمين شامل',
    FULL_INSURANCE_TOOLTIP: 'قد يشمل الإيجار تغطية أضرار التصادم والحماية من سرقة المركبة.',
    ADDITIONAL_DRIVER: 'سائق إضافي',
    INCLUDED: 'مشمول',
    AVAILABLE: 'متاحة',
    UNAVAILABLE: 'غير متاحة',
    CAR_AVAILABLE: 'مدرجة في نتائج البحث',
    CAR_AVAILABLE_TOOLTIP: 'هذه السيارة مدرجة في نتائج البحث.',
    CAR_UNAVAILABLE: 'غير مدرجة في نتائج البحث',
    CAR_UNAVAILABLE_TOOLTIP: 'هذه السيارة غير مدرجة في نتائج البحث.',
    VIEW_CAR: 'عرض هذه السيارة',
    EMPTY_LIST: 'لا توجد سيارات.',
    CANNOT_DELETE_CAR: 'لا يمكن حذف هذه السيارة لأنها مرتبطة بحجوزات. يمكنك جعلها غير متاحة للإيجار عبر تعديلها.',
    GEARBOX: 'ناقل الحركة',
    ENGINE: 'المحرك',
