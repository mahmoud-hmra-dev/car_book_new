...
const strings = new LocalizedStrings({
  ...
  ar: {
    VALIDATE_EMAIL: 'تم إرسال رسالة تحقق إلى بريدك الإلكتروني. يرجى مراجعة صندوق الوارد وتفعيل حسابك عبر الرابط الموجود في الرسالة. تنتهي صلاحية الرابط بعد يوم واحد. إذا لم تصلك الرسالة، اضغط على إعادة الإرسال.',
