...
const strings = new LocalizedStrings({
  ...
  ar: {
    ...
    LICENSE_PLATE_ALREADY_EXISTS: 'رقم اللوحة هذا موجود بالفعل.',
    CAR_IMAGE_SIZE_ERROR: `يجب أن تكون الصورة بالمقاس ${env.CAR_IMAGE_WIDTH}x${env.CAR_IMAGE_HEIGHT}`,
    RECOMMENDED_IMAGE_SIZE: `مقاس الصورة الموصى به: ${env.CAR_IMAGE_WIDTH}x${env.CAR_IMAGE_HEIGHT}`,
    SUPPLIER: 'المورد',
    LOCATIONS: 'مواقع الاستلام',
    AVAILABLE: 'مدرجة في نتائج البحث',
    CAR_TYPE: 'المحرك',
    DAILY_PRICE: 'السعر اليومي',
    DISCOUNTED_DAILY_PRICE: 'السعر اليومي المخفّض',
    HOURLY_PRICE: 'السعر بالساعة (1س)',
    DISCOUNTED_HOURLY_PRICE: 'السعر المخفّض بالساعة (1س)',
    BI_WEEKLY_PRICE: 'سعر منتصف الأسبوع (3 أيام)',
    DISCOUNTED_BI_WEEKLY_PRICE: 'سعر منتصف الأسبوع المخفّض',
    WEEKLY_PRICE: 'السعر الأسبوعي',
    DISCOUNTED_WEEKLY_PRICE: 'السعر الأسبوعي المخفّض',
    MONTHLY_PRICE: 'السعر الشهري',
    DISCOUNTED_MONThLY_PRICE: 'السعر الشهري المخفّض',
    SEATS: 'المقاعد',
    DOORS: 'الأبواب',
    GEARBOX: 'ناقل الحركة',
    AIRCON: 'مكيف',
    MINIMUM_AGE: 'الحد الأدنى للعمر',
    MINIMUM_AGE_NOT_VALID: `يجب أن يكون الحد الأدنى للعمر ${env.MINIMUM_AGE} سنة أو أكثر.`,
    CAR_RANGE: 'فئة السيارة',
    MULTIMEDIA: 'الوسائط',
    RATING: 'التقييم',
    CO2: 'CO2 (g/km)',
    COMING_SOON: 'قريبًا',
    FULLY_BOOKED: 'محجوزة بالكامل',
    IS_DATE_BASED_PRICE: 'أسعار حسب التاريخ',
    DATE_BASED_PRICES: 'أسعار حسب التاريخ',
    BLOCK_ON_PAY: 'حظر السيارة بعد نجاح الدفع',
  },
  es: {
