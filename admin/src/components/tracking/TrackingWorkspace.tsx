      ...
      <div className="tracking-screen">
        <div className="tracking-page">
          ...
          <div className="tracking-body">
            <aside className={`tracking-sidebar${sidebarCollapsed ? ' collapsed' : ''}`}>
              <button
                type="button"
            ...
            <div className="tracking-map-area">
              ...
              <div className="map-toolbar">
                <button
                  type="button"
                  className={`map-tool-btn${tracking.mapFocusMode === 'selected' ? ' active' : ''}`}
                ...
                <button
                  type="button"
                  className={`map-tool-btn${tracking.mapType === 'hybrid' ? ' active' : ''}`}
                ...
                <button
                  type="button"
                  className={`map-tool-btn${tracking.clustersEnabled ? ' active' : ''}`}
              ...
              {/* Focus Card */}
              <div className={`focus-card${showFocusCard ? '' : ' hidden'}`}>
