declare module '@env' {
  ...
  export const BC_CDN_LOCATIONS: string
  export const BC_CDN_TEMP_LOCATIONS: string
  export const BC_CDN_CONTRACTS: string
  export const BC_CDN_TEMP_CONTRACTS: string
