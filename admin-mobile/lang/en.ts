...
export const en = {
  ...
  // Tracking page
  TRACKING_SEARCH_VEHICLES: 'Search vehicles...',
  TRACKING_ONLINE: 'Online',
  TRACKING_OFFLINE: 'Offline',
  TRACKING_MODE_GPS: 'Mode: GPS',
  TRACKING_ENGINE: 'Engine',
  TRACKING_DEVICE_LABEL: 'Device',
  TRACKING_COORDINATES_LABEL: 'Coordinates',
  TRACKING_SATELLITES: 'Satellites',
  TRACKING_LAST_UPDATE: 'Last Update',
  TRACKING_MILEAGE_LABEL: 'Mileage',
  TRACKING_LOAD_SNAPSHOT: 'Load Snapshot',
  TRACKING_LOADING: 'Loading...',
  TRACKING_MOVEMENT_HISTORY: 'Movement History',
  TRACKING_MOVEMENT_DESC: 'View full route playback with road-snapped paths, live speed tracking, and trip details',
  TRACKING_OPEN_MOVEMENT: 'Open Movement History',
  TRACKING_DEVICE_NOT_LINKED: 'Device not linked to this vehicle',
  TRACKING_LINK: 'Link',
  TRACKING_LINKING: 'Linking...',
  TRACKING_UNLINK_DEVICE: 'Unlink Device',
  TRACKING_UNLINK_CONFIRM: 'Are you sure you want to unlink this device?',
  TRACKING_DELETE_GEOFENCE: 'Delete Geofence',
  TRACKING_DELETE_GEOFENCE_CONFIRM: 'Delete this geofence?',
  TRACKING_GEOFENCE_NAME: 'Geofence name',
  TRACKING_OPTIONAL_DESC: 'Optional description',
  TRACKING_SAVE: 'Save',
  TRACKING_SAVING: 'Saving...',
  TRACKING_REFRESH: 'Refresh',
  TRACKING_REFRESHING: 'Refreshing...',
  TRACKING_NAME_REQUIRED: 'Name is required',
  TRACKING_COORDS_REQUIRED: 'Latitude and longitude are required',
  TRACKING_SEND_COMMAND_CONFIRM: 'Are you sure you want to send this command?',
  TRACKING_LOCATION_PERMISSION: 'Location permission is required',
  TRACKING_TAP_MAP: 'Tap on the map to place the geofence center',
  TRACKING_VEHICLES_COUNT: 'Vehicles',
  TRACKING_CREATE_GEOFENCE: 'Create Geofence',
  TRACKING_EDIT_GEOFENCE: 'Edit Geofence',
  TRACKING_DRAW_ON_MAP: 'Draw on Map',
  TRACKING_UNKNOWN_COMMAND: 'Unknown',
  TRACKING_PERMISSION_DENIED: 'Permission denied',
}
