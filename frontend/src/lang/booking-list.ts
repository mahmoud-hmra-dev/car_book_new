...
const strings = new LocalizedStrings({
  ...
  ar: {
    ...
    DELETE_BOOKING: 'هل أنت متأكد من حذف هذا الحجز؟',
    DELETE_BOOKINGS: 'هل أنت متأكد من حذف الحجوزات المحددة؟',
    ...
    CANCEL_BOOKING: 'هل أنت متأكد من إلغاء هذا الحجز؟',
    CANCEL_BOOKING_REQUEST_SENT: 'تم إرسال طلب الإلغاء الخاص بك. سنتواصل معك لإتمام إجراءات الإلغاء.',
  },
  es: {
    CAR: 'Coche',
    SUPPLIER: 'Proveedor',
