...
const strings = new LocalizedStrings({
  ...
  en: {
    ...
    EMAIL_INFO: 'Use a valid email address for your booking details.',
    ...
    PAY_LATER_SUCCESS: 'Your booking was successfully done.',
  ...
  ar: {
    ...
    EMAIL_INFO: 'ستتلقى رسالة تأكيد على هذا البريد الإلكتروني.',
    PHONE_INFO: 'إذا احتجنا إلى التواصل معك بشكل عاجل.',
    PAYMENT: 'دفع آمن',
    CARD_NUMBER: 'رقم البطاقة',
    CARD_NUMBER_NOT_VALID: 'رقم البطاقة غير صالح',
    CARD_EXPIRY_NOT_VALID: 'تاريخ انتهاء الصلاحية غير صالح',
    CVV_NOT_VALID: 'رمز التحقق من البطاقة غير صالح',
    BOOK: 'احجز الآن',
    SIGN_IN: 'تسجيل الدخول؟',
    SECURE_PAYMENT_INFO: 'بياناتك محمية عبر دفع SSL الآمن.',
    SUCCESS: 'تمت عملية الدفع بنجاح. لقد أرسلنا لك رسالة تأكيد عبر البريد الإلكتروني.',
    PAY_LATER_SUCCESS: 'تم إتمام حجزك بنجاح. لقد أرسلنا لك رسالة تأكيد عبر البريد الإلكتروني.',
    PAYMENT_OPTIONS: 'خيارات الدفع',
    PAY_LATER: 'ادفع عند الاستلام',
    PAY_LATER_INFO: 'ادفع المبلغ الكامل عند استلام السيارة. قد يُطلب تأمين قابل للاسترداد.',
    PAY_DEPOSIT: 'ادفع العربون عبر الإنترنت وأكد الحجز',
    PAY_DEPOSIT_INFO: 'ادفع العربون عبر الإنترنت لتأكيد الحجز. يتم دفع الرصيد المتبقي عند الاستلام.',
    DEPOSIT: 'العربون',
    PAY_ONLINE: 'ادفع بدون عربون واحجز السيارة',
    PAY_ONLINE_INFO: 'أكد حجزك عبر الإنترنت بدون دفعة مسبقة. ادفع المبلغ الكامل عند الاستلام.',
    PAY_IN_FULL: 'ادفع كامل المبلغ عبر الإنترنت واحجز السيارة',
    PAY_IN_FULL_INFO: 'العربون مشمول. التعديلات والإلغاء وفق الشروط.',
    PAYMENT_FAILED: 'فشلت عملية الدفع.',
    CHECKING: 'جارٍ التحقق...',
    LICENSE_REQUIRED: 'رخصة القيادة مطلوبة',
    PRICE_FOR: 'السعر لمدة',
    DAY: 'يوم',
    PICK_UP_CHECKLIST_TITLE: 'قائمة الاستلام الخاصة بك',
    PICK_UP_CHECKLIST_ARRIVE_ON_TIME_TITLE: 'احضر في الوقت المحدد',
    PICK_UP_CHECKLIST_ARRIVE_ON_TIME_CONTENT: 'تسمح لك شركات التأجير باستلام المفاتيح فقط في وقت الاستلام المحدد لك. عادةً ما تحتفظ السيارة لفترة محدودة بعد وقت الاستلام المقرر، وبعدها قد تُعطى لعميل آخر.',
    PICK_UP_CHECKLIST_DOCUMENTS_TITLE: 'ما الذي يجب أن تحضره معك',
