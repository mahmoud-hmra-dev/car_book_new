...
const strings = new LocalizedStrings({
  ...
  ar: {
    NEW_CAR: 'سيارة جديدة',
    DELETE_CAR: 'هل أنت متأكد من حذف هذه السيارة؟',
    ...
    FUEL_POLICY_LIKE_FOR_LIKE_TOOLTIP: 'تُسلَّم هذه السيارة بكمية وقود معينة ويجب إرجاعها بنفس كمية الوقود.',
    FUEL_POLICY_FREE_TANK_TOOLTIP: 'السعر يشمل خزان وقود ممتلئ.',
    FUEL_POLICY_FULL_TO_FULL_TOOLTIP: 'تُسلَّم هذه السيارة بخزان وقود ممتلئ ويجب إرجاعها بخزان ممتلئ.',
    FUEL_POLICY_FULL_TO_EMPTY_TOOLTIP: 'تُسلَّم هذه السيارة بخزان وقود ممتلئ ويجب إرجاعها بخزان فارغ.',
    DIESEL_TOOLTIP: 'هذه السيارة مزودة بمحرك ديزل',
    GASOLINE_TOOLTIP: 'هذه السيارة مزودة بمحرك بنزين',
    ...
    GEARBOX_MANUAL_TOOLTIP: 'هذه السيارة مزودة بناقل حركة يدوي',
    GEARBOX_AUTOMATIC_TOOLTIP: 'هذه السيارة مزودة بناقل حركة أوتوماتيكي',
    ...
    THEFT_PROTECTION_TOOLTIP: 'قد يشمل الإيجار حماية ضد السرقة.',
    COLLISION_DAMAGE_WAVER: 'تغطية أضرار التصادم',
    COLLISION_DAMAGE_WAVER_TOOLTIP: 'قد يشمل الإيجار تغطية أضرار التصادم.',
    FULL_INSURANCE: 'تأمين شامل',
    FULL_INSURANCE_TOOLTIP: 'قد يشمل الإيجار تغطية أضرار التصادم وحماية السيارة من السرقة.',
    ADDITIONAL_DRIVER: 'سائق إضافي',
    INCLUDED: 'مضمن',
    UNAVAILABLE: 'غير متاح',
    CAR_AVAILABLE: 'متاحة للإيجار',
    CAR_AVAILABLE_TOOLTIP: 'هذه السيارة متاحة للإيجار.',
    CAR_UNAVAILABLE: 'غير متاحة للإيجار',
    CAR_UNAVAILABLE_TOOLTIP: 'هذه السيارة غير متاحة للإيجار.',
