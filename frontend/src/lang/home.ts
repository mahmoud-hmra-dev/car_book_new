...
const strings = new LocalizedStrings({
  fr: {
    ...
    // New Figma redesign strings
    HERO_HEADING: 'Trouvez, Réservez et Louez une voiture Facilement',
    HERO_SUBTEXT: 'Obtenez les meilleures offres sur les voitures de location. Comparez les prix, choisissez votre véhicule préféré et profitez de la route en toute confiance.',
    LETS_GO: 'C\'est parti',
    STEP_PICK_DATE: 'Date de prise en charge',
    STEP_PICK_DATE_DESC: 'Sélectionnez la date et l\'heure de prise en charge qui vous conviennent le mieux.',
    STEP_BOOK_CAR: 'Réservez votre voiture',
    STEP_BOOK_CAR_DESC: 'Choisissez parmi notre large sélection et confirmez votre réservation en quelques clics.',
    STEP_ENJOY_RIDE: 'Profitez du trajet',
    STEP_ENJOY_RIDE_DESC: 'Récupérez votre voiture et profitez d\'une expérience de conduite sans stress.',
    POPULAR_CARS: 'Voitures les plus populaires',
    VIEW_DETAILS: 'Voir les détails',
    PER_DAY: '/par jour',
    AUTOMAT: 'Automat',
    FUEL_PB95: 'PB 95',
    AIR_CONDITIONER: 'Climatisation',
    BRAND_LOGOS_TITLE: 'Nos marques partenaires',
  ...
  en: {
    ...
    // New Figma redesign strings
    HERO_HEADING: 'Find, Book & Rent a Car Easily',
    HERO_SUBTEXT: 'Get the best deals on rental cars. Compare prices, choose your favorite vehicle, and hit the road with confidence.',
    LETS_GO: "Let's go",
    STEP_PICK_DATE: 'Pick-up Date',
    STEP_PICK_DATE_DESC: 'Select the pick-up date and time that works best for you.',
    STEP_BOOK_CAR: 'Book Your Car',
    STEP_BOOK_CAR_DESC: 'Choose from our wide selection and confirm your booking in just a few clicks.',
    STEP_ENJOY_RIDE: 'Enjoy Your Ride',
    STEP_ENJOY_RIDE_DESC: 'Pick up your car and enjoy a stress-free driving experience.',
    POPULAR_CARS: 'Most Popular Cars',
    VIEW_DETAILS: 'View Details',
    PER_DAY: '/per day',
    AUTOMAT: 'Automat',
    FUEL_PB95: 'PB 95',
    AIR_CONDITIONER: 'Air Conditioner',
    BRAND_LOGOS_TITLE: 'Our Partner Brands',
  ...
  ar: {
    ...
    // New Figma redesign strings
    HERO_HEADING: 'ابحث، احجز واستأجر سيارة بسهولة',
    HERO_SUBTEXT: 'احصل على أفضل العروض على السيارات المستأجرة. قارن الأسعار، اختر سيارتك المفضلة، وانطلق على الطريق بثقة.',
    LETS_GO: 'هيا بنا',
    STEP_PICK_DATE: 'تاريخ الاستلام',
    STEP_PICK_DATE_DESC: 'حدد تاريخ ووقت الاستلام الأنسب لك.',
    STEP_BOOK_CAR: 'احجز سيارتك',
    STEP_BOOK_CAR_DESC: 'اختر من مجموعتنا الواسعة وأكد حجزك بنقرات قليلة.',
    STEP_ENJOY_RIDE: 'استمتع بالرحلة',
    STEP_ENJOY_RIDE_DESC: 'استلم سيارتك واستمتع بتجربة قيادة خالية من التوتر.',
    POPULAR_CARS: 'السيارات الأكثر شعبية',
    VIEW_DETAILS: 'عرض التفاصيل',
    PER_DAY: '/في اليوم',
    AUTOMAT: 'أوتوماتيك',
    FUEL_PB95: 'PB 95',
    AIR_CONDITIONER: 'مكيف الهواء',
    BRAND_LOGOS_TITLE: 'علاماتنا التجارية الشريكة',
  ...
  es: {
    ...
    // New Figma redesign strings
    HERO_HEADING: 'Encuentra, Reserva y Alquila un Coche Fácilmente',
    HERO_SUBTEXT: 'Obtén las mejores ofertas en coches de alquiler. Compara precios, elige tu vehículo favorito y sal a la carretera con confianza.',
    LETS_GO: 'Vamos',
    STEP_PICK_DATE: 'Fecha de recogida',
    STEP_PICK_DATE_DESC: 'Selecciona la fecha y hora de recogida que mejor te convenga.',
    STEP_BOOK_CAR: 'Reserva tu coche',
    STEP_BOOK_CAR_DESC: 'Elige de nuestra amplia selección y confirma tu reserva en solo unos clics.',
    STEP_ENJOY_RIDE: 'Disfruta del viaje',
    STEP_ENJOY_RIDE_DESC: 'Recoge tu coche y disfruta de una experiencia de conducción sin estrés.',
    POPULAR_CARS: 'Coches más populares',
    VIEW_DETAILS: 'Ver detalles',
    PER_DAY: '/por día',
    AUTOMAT: 'Automático',
    FUEL_PB95: 'PB 95',
    AIR_CONDITIONER: 'Aire acondicionado',
    BRAND_LOGOS_TITLE: 'Nuestras marcas asociadas',
